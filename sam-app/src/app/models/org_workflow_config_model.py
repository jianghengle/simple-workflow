...
class OrgWorkflowConfigModel(Model):
    Fields = ['id', 'name', 'description', 'tableName', 'fields', 'states', 'userGroup', 'adminGroup', 'createdAt', 'updatedAt', 'updatedBy', 'isDeleted', 'count', 'creationButton', 'creationNotifyingGroups', 'creationNotifyingOthers']
